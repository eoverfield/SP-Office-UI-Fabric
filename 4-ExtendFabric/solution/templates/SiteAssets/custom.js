...
(function (fabric) {
    var DialogCustom = (function () {
        ...
        DialogCustom.prototype.open = function () {
            this._dialog.classList.add("is-open");
            this.center();
        ...
        DialogCustom.prototype.animateInPanel = function (layer) {
        ...
        DialogCustom.prototype.center = function () {
            var clientWidth = document.documentElement.clientWidth;
            var clientHeight = document.documentElement.clientHeight;
            var dialogWidth = this._dialog.offsetWidth;
            var dialogHeight = this._dialog.offsetHeight;
            var offsetTop;
        ...
        DialogCustom.prototype._setEvents = function () {
        ...
        DialogCustom.prototype.setConfiguration = function (options) {
            if (options) {
                if (options._dialog) {
    ...
    fabric.DialogCustom = DialogCustom;
})(fabric || (fabric = {}));
...
(function (fabric) {
     ...
     *
     */
    var DIALOG_HOST_CLASS = "ms-DialogHost-Custom";
    var DialogHostCustom = (function () {
        /**
         *
         * @param {HTMLElement} container - the target container for an instance of Panel
         * @constructor
         */
        function DialogHostCustom(options) {
            this._configuration = {};
            this.setConfiguration(options);
        ...
        DialogHostCustom.prototype._createElements = function () {
        ...
        DialogHostCustom.prototype._renderElements = function () {
        ...
        DialogHostCustom.prototype.update = function (layer, callBack) {
            this._dialogHost.replaceChild(layer, layer);
            if (callBack) {
                callBack();
            }
        };
        DialogHostCustom.prototype.dismiss = function () {
            //hide the overlay
            this._overlay.hide();
            //remove the panel
            document.body.removeChild(this._dialogHost);
        };
        DialogHostCustom.prototype.setConfiguration = function (options) {
            if (options) {
                if (options.overlayClass) {
                    this._configuration.overlayClass = options.overlayClass;
                }
        ...
        return DialogHostCustom;
    }());
    fabric.DialogHostCustom = DialogHostCustom;
})(fabric || (fabric = {}));
